...
<div class="logo">
    ...
    <a class="navItem" href="#ideas">Conviértete en orador</a>
...
<section id="imagenPrincipal">
    ...
    Bs As llega por primera vez a Argentina. Un evento para compartir con nuestra comunidad el conocimiento y experiencia con los expertos que están creando el futuro de Internet. Ven a conocer mienbros de nuestros eventos, estudiantes de Codo a Codo y oradores de primer nivel que tenemos para tí. Te esperamos!</p><a class="texto blog" href="./tickets.html">Comprar tickets</a>
    <a class="texto idea" href="#ideas">Quiero ser orador</a>
</section>

<section id="cajaJuegos">
   <div class="seccionTitulo"><p>Conocé a los</p><h2>oradores</h2></div>
    <div class="juego">
...
<section id="ideas">
    <div class="seccionTitulo"><p>Conviértete en</p><h2>orador</h2></div>
   
    
 <div class="tituloFormulario">Anótate como orador para dar una charla ignite. Cuéntanos de qué quieres hablar. 
        <form class="formulario" id="formularioIdeas" method="post">
            ...
            <div class="lineaFormulario">
                ...
                <input class="campo" name="email" type="email" id="email" placeholder="Dirección de email válida"></div>
            <div class="lineaFormulario">
...
<button id="resumen" type="button">Enviar</button>
 ...
 <%
    ...
    //(nombre + ", gracias por enviarnos tu propuesta, te sugerimos estar atento a la dirección de mail enviada: "+email+"Finalmente, te sugerimos consultar nuestro calendario para ver las otras propuestas");
    %>
     </br></br></div>
</section>
</main>
...
//esto es JavaScript 
  function permisosMenu() {
      var cadena =" <%=nombre + ", gracias por enviarnos tu propuesta, te sugerimos estar atento a la dirección de mail enviada: "+ email%>";
  alert(cadena);
}
permisosMenu();
</script> 
